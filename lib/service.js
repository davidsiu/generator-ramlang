 ...
 */
module.exports.generate = function(moduleName, providerName, ramlResourceObj, withModule, selectedMediaTypeExtension) {
  ...
  ramlResourceObj.methods = methods.generate(ramlResourceObj, providerName, selectedMediaTypeExtension);
