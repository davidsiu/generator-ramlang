...
var getParametersForMethod = function(ramlResource, method, relativeUri) {
  ...
  var resourceIdName = generatorUtil.getResourceIdName(relativeUri);
  ...
  switch (method) {
    case 'query':
      ...
      break;
    case 'get':
      params.push(resourceIdName);
      apiParams.push(resourceIdName);
      break;
    case 'post':
      params.push('entity');
    ...
    case 'put':
      params.push('entity');
      apiParams.push('entity.' + resourceIdName, 'entity');
      break;
    case 'delete':
      params.push(resourceIdName);
      apiParams.push(resourceIdName);
...
var isCollection = function(ramlResource) {
  // Get either 'id' or '<resource>Id'
  var resourceIdName = generatorUtil.getResourceIdName(ramlResource.relativeUri);
  return (!_.isEmpty(ramlResource) &&
             (_.isEmpty(ramlResource.uriParameters) ||
              _.isUndefined(ramlResource.uriParameters[resourceIdName]))) ||
